...
public class SqlUtil {
	...
	private static List<String> praseParams(String sql) {
		...
		Set<org.alvin.cishan.sys.util.ParamPos> posList = new HashSet<>();
		List<String> nameList = new ArrayList<>();
		org.alvin.cishan.sys.util.ParamPos pos;
		for (int i = 0; i < arr.length; i++) {
			if (arr[i] == ':') {
				pos = new org.alvin.cishan.sys.util.ParamPos();
				pos.setStart(i);
		...
		StringBuffer name;
		for (org.alvin.cishan.sys.util.ParamPos paramPos : posList) {
