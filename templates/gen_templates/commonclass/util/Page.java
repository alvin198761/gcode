...
//		return Collections.unmodifiableList(this.content);
	...
	public <S> org.alvin.cishan.sys.util.Page<S> map(List<S> content) {
		org.alvin.cishan.sys.util.Page<S> page = new org.alvin.cishan.sys.util.Page<S>();
		if (content != null) {
	...
	public static <S> org.alvin.cishan.sys.util.Page<S> map(List<S> content, int number, int size, long totalElements) {
		org.alvin.cishan.sys.util.Page<S> page = new org.alvin.cishan.sys.util.Page<S>();
		page.content.addAll(content);
		page.number = number;
		page.size = size;
