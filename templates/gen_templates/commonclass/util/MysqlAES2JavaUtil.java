...
public class MysqlAES2JavaUtil {
	...
	public static String mysql_aes_decrypt(String content, String key) throws Exception {
		...
		return new String(decryptCipher.doFinal(org.alvin.cishan.sys.util.HexUtil.decodeHex(content.toLowerCase().toCharArray())));
	}
	...
	public static String mysql_aes_encrypt(String content, String key) throws Exception {
		...
		return new String(org.alvin.cishan.sys.util.HexUtil.encodeHex(encryptCipher.doFinal(content.getBytes("UTF-8")))).toUpperCase();
	}
