...
public class DefaultExceptionHandler {
	...
	private final Logger logger = LoggerFactory.getLogger(org.alvin.cishan.common.exception.DefaultExceptionHandler.class);
	...
	public ExceptionMessage processException(Locale locale, Exception ex) {
		...
		return new ExceptionMessage(org.alvin.cishan.common.exception.ErrorCode.EGENERALEXCEPTION,
				messageSource.getMessage(String.valueOf(org.alvin.cishan.common.exception.ErrorCode.EGENERALEXCEPTION), null, locale));
	}
	...
	@ExceptionHandler({ org.alvin.cishan.common.exception.BusinessException.class })
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ResponseBody
	public ExceptionMessage processBusinessException(Locale locale, org.alvin.cishan.common.exception.BusinessException ex) {
