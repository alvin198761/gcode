...
import ${project.base_package}.common.acl.UserAuthenticationProvider;
import ${project.base_package}.config.UserSession;
import ${project.base_package}.sys.auth.adminfunc.AdminFunc;
import ${project.base_package}.sys.util.MessageInfo;
...
/**
 * Created by ${project.author} on ${project.date}.
 */
@Controller
